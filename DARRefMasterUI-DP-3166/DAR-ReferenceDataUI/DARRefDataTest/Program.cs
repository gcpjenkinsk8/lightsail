...
namespace DARRefDataTest
{
    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            DARApplicationInfo.SingleStorePublicDB = GetConnectionStringSingleStorePublic();
        ...
        private static void TEST_HighLow()
        {
            ...
            var hasAccess = c.HasAccessToMarketCap(clientId);
        ...
        private static void TEST_MarketCap()
        {
            ...
            if (hasAccess)
            {
                ...
                var result = p.GetHourlyMarketCap(new string[] { "BTC" },"USD", "2023-01-30 01:10:32", "2023-01-31 02:10:32", clientId);
